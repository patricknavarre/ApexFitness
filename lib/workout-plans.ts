...
export const WORKOUT_PLANS: WorkoutPlan[] = [
  ...
  },
  {
    ...
    goal: 'Rebuild ankle strength, balance, and mobility after walking boot',
    daysPerWeek: 4,
    ...
    days: [
      ...
      { dayNumber: 5, title: 'Mobility & Endurance', isRest: false, exercises: [{ name: 'See workout mode', sets: '—', reps: '—' }] },
      { dayNumber: 6, title: 'Rest', isRest: true, exercises: [] },
      { dayNumber: 7, title: 'Rest', isRest: true, exercises: [] },
    ],
    progressionRules: [
    ...
    notes: [
      'Can run as your main plan or on rest days alongside Gym Return / muscle plans',
      'Band 4-way + calves + balance is the core of post-boot ankle rehab',
